...
void main() {
  group('Membuat Page Home', () {
    ...
    testWidgets('Mengecek Widget pada Page Home', (WidgetTester tester) async {
      ...
      final refreshIndicator = find.byType(RefreshProgressIndicator);
  ...
  group('Pengujian perilaku post', () {
    ...
    testWidgets('Menampilkan post dalam card dan list view',
      ...
      FakeAsync().run((time) async {
        time.elapse(Duration(minutes: 1));
    ...
    testWidgets('Pengujian animasi apabila konten terlalu panjang',
        (WidgetTester tester) {
      // TODO: Implement animation testing inside card view
    });
  });
}
